...
public class C01_Variables {
	public static void main(String[] args) {
		 ...
		 * soyisminiz : Bulut seklinde yazdirin
		 */
		...
		// 3- Iki farkli tamsayi data turunde 2 variable olusturun bunlarin toplamini
		// yazdirin
		int sayi1 = 10;
		byte sayi2 = 5;
		...
		// String ve sayisal islemleri birlikte yaptirdigimizda matematiksel islemi
		// parantez icine alin

		// 4- Bir tamsayi ve bir ondalikli variable olusturun ve bunlarin toplamini
		// yazdirin
		int sayi3 = 15;
		double sayi4 = 3.14;
		...
		// 6- Bir tamsayi, bir de char degisken olusturun ve bunlarin toplamini
		// yazdirin.
		...
		// char data turundeki degiskenler matematiksel islemlerde kullanilirsa ASCII
		// tablosu devere girer
